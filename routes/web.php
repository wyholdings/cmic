...
$router->get('/program', [App\Controllers\HomeController::class, 'program']);
$router->get('/registration', [App\Controllers\HomeController::class, 'registration']);
$router->get('/confirmation', [App\Controllers\HomeController::class, 'confirmation']);
$router->get('/notice', [App\Controllers\HomeController::class, 'notice']);
